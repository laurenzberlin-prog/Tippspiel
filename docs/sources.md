...
Zu keinem Zeitpunkt wurden KI-Tools als Copy & Paste Tool verwendet oder Aufgaben zur Entscheidungen über Funktionen und Aussehen der Anwendungen, Durchführung, Ausbesserungen oder  Implementierung übergeben. Ausgenommen ist reine Code-Completion.